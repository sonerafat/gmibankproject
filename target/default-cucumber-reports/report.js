...
formatter.step({
  "name": "user clicks to login icon",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "user clicks to Sign in",
  "keyword": "And "
});
formatter.match({
  "location": "gmibank.stepdefinitions.EmpAccCreationStepDefinitions.user_cliks_to_Sign_in()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user clicks to Sign in button",
  "keyword": "And "
});
formatter.match({
  "location": "gmibank.stepdefinitions.EmpAccCreationStepDefinitions.user_clicks_to_Sign_in_button()"
});
formatter.result({
  "status": "passed"
});
