...
Feature: Go to login
  ...
  Scenario: Create new customer
    ...
    And put  "hakan" into create firstname form
    And put "sukur" into create lastname form
    And put "S" into middle initial customer form
    And put "info@fmail.com" into mail customer form
    And put "012-123-4589" into mobile phoneNumber
    ...
    And put "789-45-9003"into ssnForm customer form
